...
# write json file
def nuread(pathh, path_position):
    ...
    # open txt file
    for i in trange(1, 40000):
        file_no = 1500000000000000 + i + n
        ...
        if os.path.exists(label_2):
            ...
            ego_x, ego_y, ego_z, ego_roll, ego_pitch, ego_yaw = position_data[0]
...
if __name__ == '__main__':
    ...
    pat = "./label_2"
    pat_position = "./position"
    nuread(pat, pat_position)
