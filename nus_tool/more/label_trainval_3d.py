    ...
    for i in range(1, 40000):
        ...
        if f[-3] != 'x':
            ...
            for data in datas:
                ...
                # pool.append([[psi0, z1[0]], [psi0, z2[0]], [psi1, z1[1]], [psi1, z2[1]], [psi2, z1[2]], [psi2, z2[2]], [psi3, z1[3]], [psi3, z2[3]]])
                c_i += 1
            ...
            for data in datas:
                ...
                if non_overlapping_ratio >= 0.8:
                    visibility_token = 4
                elif non_overlapping_ratio >= 0.6:
                    visibility_token = 3
                elif non_overlapping_ratio >= 0.4:
                    visibility_token = 2
                else:
                    visibility_token = 1
                ...
                if data[0] == 'pedestrian':
                    sample_annotation_json.append({
                        ...
                        'size': [1.15 * float(data[9]), 1.15 * float(data[10]), float(data[8])],
                        'rotation': rotation1,
                        'prev': '',
                        'next': '',
                        'num_lidar_pts': 10,
